...
export default function FileManager({ fm, user }: Props) {
    ...
    console.log(downCnt, upCnt, totalCnt)
    return (
        <>
            <button onClick={() => fm?.dispatch({ type: FileActionType.TOGGLE_MENU })} className="relative outline-none text-file px-2 hover:text-filehover">
